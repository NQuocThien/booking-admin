...
const HC_BLOCK_CONTENT = "handle-change-block-content";
const HC_IS_BLOCK = "handle-change-is-block";
...
export const handleChangeIsBlock = (value: boolean): IAction => {
  return {
    type: HC_IS_BLOCK,
    payload: value,
  };
};
export const handleChangeBlockConent = (value: string): IAction => {
  return {
    type: HC_BLOCK_CONTENT,
    payload: value,
  };
};
...
export const reducer = (
  ...
  switch (action.type) {
    ...
    case HC_BLOCK_CONTENT:
      return {
        ...state,
        blockContent: action.payload,
      };
    case HC_IS_BLOCK:
      return {
        ...state,
