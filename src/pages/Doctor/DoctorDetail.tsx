...
import { FaPhone, FaRegTrashCan } from "react-icons/fa6";
import { IoMdTransgender } from "react-icons/io";
import { getAcademicTitle, getDayOfWeek, getDegree } from "src/utils/getData";
          ...
          <div className={`${s.component} my-3`}>
            ...
            <div>
              ...
              <Table striped bordered hover>
                ...
                <tbody>
                  {data?.getDoctorbyId.workSchedule.schedule.map((s, i) => (
                    <tr key={i}>
